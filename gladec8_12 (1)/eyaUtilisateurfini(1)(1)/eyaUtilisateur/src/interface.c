...
create_acceuilw (void)
{
  ...
  label2 = gtk_label_new_with_mnemonic (_("Gestion  utilisateur"));
...
create_gestionw (void)
{
  ...
  GtkWidget *label71;
  GtkWidget *alo;
  GtkWidget *labelnombres;
  GtkWidget *comboboxchoixs;
  GtkWidget *label52;

  gestionw = gtk_window_new (GTK_WINDOW_TOPLEVEL);
  gtk_widget_set_size_request (gestionw, 1000, 800);
  gtk_window_set_title (GTK_WINDOW (gestionw), _("gestion utilisateur"));
  ...
  label11w = gtk_label_new (_("<span foreground=\"black\" ><b>Ajouter utilisateur :</b></span>"));
  ...
  label5w = gtk_label_new (_("Role : "));
  gtk_widget_show (label5w);
  gtk_fixed_put (GTK_FIXED (fixed3), label5w, 72, 432);
  ...
  vt = gtk_label_new (_("vote :"));
  gtk_widget_show (vt);
  gtk_fixed_put (GTK_FIXED (fixed3), vt, 72, 592);
  gtk_widget_set_size_request (vt, 49, 17);
  ...
  voteb = gtk_entry_new ();
  gtk_widget_show (voteb);
  gtk_fixed_put (GTK_FIXED (fixed3), voteb, 160, 576);
  gtk_widget_set_size_request (voteb, 160, 27);
  gtk_entry_set_visibility (GTK_ENTRY (voteb), FALSE);
  gtk_entry_set_invisible_char (GTK_ENTRY (voteb), 8226);

  label8w = gtk_label_new (_("<span foreground=\"red\" ><b>Saisir role !</b></span>"));
  gtk_fixed_put (GTK_FIXED (fixed3), label8w, 96, 448);
  ...
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox2w), _("electeur"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox2w), _("agent_bureau_de_vote"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox2w), _("condidat"));
  ...
  saisirvote = gtk_label_new (_("<span foreground=\"red\" ><b>Saisir vote !</b></span>"));
  gtk_fixed_put (GTK_FIXED (fixed3), saisirvote, 88, 592);
  gtk_widget_set_size_request (saisirvote, 216, 64);
  gtk_label_set_use_markup (GTK_LABEL (saisirvote), TRUE);
  ...
  label34w = gtk_label_new (_("<span foreground=\"red\" ><b> utilisateur existant !</b></span>"));
  ...
  label35w = gtk_label_new (_("<span foreground=\"green\" ><b> utilisateur ajout\303\251 avec succes !</b></span>"));
  ...
  saisirnum = gtk_label_new (_("<span foreground=\"red\" ><b>Saisir  numero bureau!</b></span>"));
  ...
  numb12 = gtk_label_new (_("num\303\251ro bureau :"));
  ...
  label37w = gtk_label_new (_("<span foreground=\"green\" ><b>utilisateur Modifi\303\251 avec succes </b></span>"));
  ...
  label36w = gtk_label_new (_("<span foreground=\"black\" ><b>Modifier utilisateur de cin  :</b></span>"));
  ...
  votem = gtk_entry_new ();
  gtk_widget_show (votem);
  gtk_fixed_put (GTK_FIXED (fixed4), votem, 216, 552);
  gtk_widget_set_size_request (votem, 192, 27);
  gtk_entry_set_invisible_char (GTK_ENTRY (votem), 8226);

  label67 = gtk_label_new (_("Numero bureau"));
  gtk_widget_show (label67);
  gtk_fixed_put (GTK_FIXED (fixed4), label67, 56, 504);
  gtk_widget_set_size_request (label67, 137, 25);

  label68 = gtk_label_new (_("vote"));
  gtk_widget_show (label68);
  gtk_fixed_put (GTK_FIXED (fixed4), label68, 96, 552);
  gtk_widget_set_size_request (label68, 49, 17);

  label18w = gtk_label_new (_("Role : "));
  ...
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox4w), _("electeur"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox4w), _("agent_bureau_de_vote"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox4w), _("condidat"));
  ...
  label54 = gtk_label_new_with_mnemonic (_("Choisir le role \303\240 calculer :"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), labelnombre, 184, 176);
  gtk_widget_set_size_request (labelnombre, 361, 72);

  label701212 = gtk_label_new (_("Choisir le sexe \303\240 calculer :"));
  gtk_widget_show (label701212);
  gtk_fixed_put (GTK_FIXED (fixed7), label701212, 0, 424);
  gtk_widget_set_size_request (label701212, 328, 33);

  comboboxchoix = gtk_combo_box_new_text ();
  gtk_widget_show (comboboxchoix);
  gtk_fixed_put (GTK_FIXED (fixed7), comboboxchoix, 88, 104);
  gtk_widget_set_size_request (comboboxchoix, 152, 48);
  gtk_combo_box_append_text (GTK_COMBO_BOX (comboboxchoix), _("electeur"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (comboboxchoix), _("agent_bureau_de_vote"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (comboboxchoix), _("condidat"));

  nbrvt = gtk_button_new_with_mnemonic (_("Nombre des votes blanc"));
  gtk_widget_show (nbrvt);
  gtk_fixed_put (GTK_FIXED (fixed7), nbrvt, 64, 288);
  gtk_widget_set_size_request (nbrvt, 304, 29);

  validert = gtk_button_new ();
  gtk_widget_show (validert);
  gtk_fixed_put (GTK_FIXED (fixed7), validert, 104, 160);
  ...
  validerts = gtk_button_new ();
  gtk_widget_show (validerts);
  gtk_fixed_put (GTK_FIXED (fixed7), validerts, 96, 528);
  gtk_widget_set_size_request (validerts, 122, 40);

  alignment18 = gtk_alignment_new (0.5, 0.5, 0, 0);
  gtk_widget_show (alignment18);
  gtk_container_add (GTK_CONTAINER (validerts), alignment18);
  ...
  label71 = gtk_label_new_with_mnemonic (_("Valider"));
  gtk_widget_show (label71);
  gtk_box_pack_start (GTK_BOX (hbox18), label71, FALSE, FALSE, 0);

  alo = gtk_label_new ("");
  gtk_widget_show (alo);
  gtk_fixed_put (GTK_FIXED (fixed7), alo, 400, 256);
  gtk_widget_set_size_request (alo, 520, 88);
  gtk_misc_set_alignment (GTK_MISC (alo), 0.5, 0.45);

  labelnombres = gtk_label_new ("");
  gtk_widget_show (labelnombres);
  gtk_fixed_put (GTK_FIXED (fixed7), labelnombres, 256, 528);
  gtk_widget_set_size_request (labelnombres, 400, 73);

  comboboxchoixs = gtk_combo_box_new_text ();
  gtk_widget_show (comboboxchoixs);
  gtk_fixed_put (GTK_FIXED (fixed7), comboboxchoixs, 80, 464);
  gtk_widget_set_size_request (comboboxchoixs, 152, 48);
  gtk_combo_box_append_text (GTK_COMBO_BOX (comboboxchoixs), _("Male"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (comboboxchoixs), _("Femelle"));

  label52 = gtk_label_new_with_mnemonic (_(" <span foreground=\"purple\"><b>taux par role </b></span>"));
  ...
  g_signal_connect ((gpointer) treeview2w, "row_activated",
                    ...
                    NULL);
  g_signal_connect ((gpointer) nbrvt, "clicked",
                    G_CALLBACK (on_nbrvt_clicked),
                    NULL);
  g_signal_connect ((gpointer) validert, "clicked",
                    G_CALLBACK (on_validersomme_clicked),
                    NULL);
  g_signal_connect ((gpointer) validerts, "clicked",
                    G_CALLBACK (on_validerts_clicked),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (gestionw, vt, "vt");
  GLADE_HOOKUP_OBJECT (gestionw, numb, "numb");
  GLADE_HOOKUP_OBJECT (gestionw, voteb, "voteb");
  ...
  GLADE_HOOKUP_OBJECT (gestionw, saisirvote, "saisirvote");
  ...
  GLADE_HOOKUP_OBJECT (gestionw, votem, "votem");
  ...
  GLADE_HOOKUP_OBJECT (gestionw, label701212, "label701212");
  GLADE_HOOKUP_OBJECT (gestionw, comboboxchoix, "comboboxchoix");
  GLADE_HOOKUP_OBJECT (gestionw, nbrvt, "nbrvt");
  ...
  GLADE_HOOKUP_OBJECT (gestionw, validerts, "validerts");
  GLADE_HOOKUP_OBJECT (gestionw, alignment18, "alignment18");
  GLADE_HOOKUP_OBJECT (gestionw, hbox18, "hbox18");
  GLADE_HOOKUP_OBJECT (gestionw, image18, "image18");
  GLADE_HOOKUP_OBJECT (gestionw, label71, "label71");
  GLADE_HOOKUP_OBJECT (gestionw, alo, "alo");
  GLADE_HOOKUP_OBJECT (gestionw, labelnombres, "labelnombres");
  GLADE_HOOKUP_OBJECT (gestionw, comboboxchoixs, "comboboxchoixs");
